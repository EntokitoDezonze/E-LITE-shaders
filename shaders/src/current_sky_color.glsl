...
float final_sun_factor2 = fastpow(sun_ss, dayBF(1.5, 0.0, 10.0));
    ...
    vec3 current_low_sky_color = mix(pure_low_sky_color * dayBF(0.1, 0.0, dayBF(0.1, 0.0, 0.0)) + pure_mid_sky_color * dayBF(mix(dayBF(3.5, 2.5, 1.0), dayBF(2.0, 2.0, 0.0), rainStrength), mix(1.0, 0.25, rainStrength), mix(dayBF(0.0, 0.0, 2.0), 2.0, rainStrength)) * 0.5 + low_sky_color * dayBF(0.1, 1.0, 0.05), low_sky_color * dayBFlgcy(2.0, 1.5, mix(1.25, dayBF(3.0, 3.0, 0.5), rainStrength)), final_sun_factor);
